...
usersRouter.patch('/changePassword', validator.body(changePasswordSchema), validationErrMiddleware, changePassword);
usersRouter.patch('/', validator.body(editUserSchema), validationErrMiddleware, editUser);
